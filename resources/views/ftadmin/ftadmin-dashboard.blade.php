    ...
    <div class="relative flex-1">
        ...
        <div class="p-6 lg:p-8 overflow-y-auto h-full">
            <div class="w-full max-w-[1400px] mx-auto space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-[3fr_2fr] gap-5 sm:h-[calc((100vh-14rem)/2-5px)] stagger-children">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:h-[calc((100vh-14rem)/2-5px)] stagger-children">
