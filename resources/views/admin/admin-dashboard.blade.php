            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="mt-4 sm:mt-0">
                        <button class="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-xl text-sm font-bold shadow-sm hover:bg-gray-50 transition flex items-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                        <div class="flex justify-between items-start">
                            ...
                            <span class="text-xs font-bold text-green-500 bg-green-50 px-2 py-1 rounded-lg">
                                +12%
                            </span>
                        </div>
                        <div class="mt-4">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <a href="{{ route('admin.pending.trucks') }}" class="group flex items-start p-5 bg-gray-50 hover:bg-blue-600 rounded-xl transition-all duration-300 transform hover:-translate-y-1">
                                ...
                                <div class="ml-5">
                                    ...
                                    <p class="text-sm text-gray-500 group-hover:text-blue-100 transition">Review and verify documentation.</p>
                                </div>
                            </a>
                            <a href="#" class="group flex items-start p-5 bg-gray-50 hover:bg-slate-700 rounded-xl transition-all duration-300 transform hover:-translate-y-1">
                                ...
                                <div class="ml-5">
                                    ...
                                    <p class="text-sm text-gray-500 group-hover:text-slate-200 transition font-medium">View or edit user accounts.</p>
                                </div>
                            </a>
                        </div>
                    </div>
...
@push('css')
    ...
    <style>
        /* CRITICAL: These overrides hide the default navigation and 
           padding that Breeze/Jetstream layouts usually force onto the page.
        */
