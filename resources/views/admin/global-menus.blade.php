                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <h2 class="text-lg font-bold text-gray-800">Global Menus</h2>
                        </div>
                        <p class="text-sm text-gray-500">This page is now active from the left navigation. Global menu management content can be added here.</p>
                    </div>
